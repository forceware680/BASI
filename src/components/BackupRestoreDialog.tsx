// components/BackupRestoreDialog.tsx — Modal Backup & Restore Penuh Data + File Bukti.
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl">
        ...
        {/* Tab Selection */}
        <div className="mt-4 flex rounded-xl border border-slate-200 bg-slate-50 p-1 text-xs font-semibold text-slate-600">
          <button
            type="button"
