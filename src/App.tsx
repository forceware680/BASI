        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div
              ...
              className="hidden sm:flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900 px-3 py-1.5 text-xs text-slate-600 dark:text-slate-400 shadow-sm cursor-default select-none transition-colors"
            >
